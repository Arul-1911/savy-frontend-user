...
import { Accordion, Card, Col, Form, Image, InputGroup, ProgressBar, Row } from "react-bootstrap";
          ...
          <>
            <div className="d-flex justify-content-between">
              <IoArrowBackCircleOutline
                ...
                onClick={() => hide(false)}
              />
              <h6 style={{color:'rgba(0, 74, 173, 1)'}}>Buckets & Categories</h6>
              <RxCrossCircled
            color="rgba(92, 182, 249, 1)"
            cursor={"pointer"}
            size={23}
      ...
      {accordionItems?.map((item,index)=>(
         <Accordion.Item eventKey={index} className='border-0'>
             ...
             <Accordion.Body className=' border-0 py-0'>
              ...
              <p className='my-0 py-1' style={{borderBottom:'1px solid #E2F2FF',fontWeight:'500'}}><Link  className='' style={{color:'#374957'}}>{link?.label}</Link></p>
                 ))}
