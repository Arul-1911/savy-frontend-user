...
function PlanCard({
  ...
  return (
    <Card
      ...
      onClick={() => setSelectedCard && setSelectedCard(id)}
      style={{
        background: bgColor || "#ddd",
        color: textColor || "#fff",
        cursor: "pointer",
        minHeight: "400px",
      }}
    >
      <Card.Body className="p-0">
        ...
        <Row className=" ">
          <Col className="text-center">
            <h4 className="mb-1 mt-2" style={{ fontWeight: 600 }}>
              {title}
            </h4>
            <p
              className="mt-0"
        ...
        <Row>
          <Col>
            {featureTitle && (
              <h6 className="" style={{ fontSize: "0.70rem" }}>
                {featureTitle}
              </h6>
            )}
      ...
      <Card.Footer className="bg-transparent px-0 border-0">
        <Button
          className="w-100 bg-white border-white "
